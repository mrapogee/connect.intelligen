        ...
        '<uib-accordion>' +
          ...
          '<div uib-accordion-group heading="When" class="panel panel-default" is-open="status.advanced">' +
            '<div class="when-block" ng-repeat="condition in component.whenConditions">' +
              ...
              'Then:' +
              '<select class="form-control input-md" ng-model="component.whenConditions[0].type" ng-options="type.id as type.label for type in conditions track by type.id"></select>' +
