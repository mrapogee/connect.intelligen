...
app.config([
  ...
  function(
    ...
    formioComponentsProvider.registerCondition({
      id: 'set-next-page',
      label: 'Set Next Page',
      template: '<br>Next Page:<select class="form-control input-md" ng-model="condition.targetPage" ng-options="page.key as page.title for page in pages track by page.key"></select>',
